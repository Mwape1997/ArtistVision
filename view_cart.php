...
<div class="wrapper">
    <div class="page-header clear-filter">
        <div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/black-friday-buy-credit-card-34577.jpg');">
        </div>
        <div class="content-center">
            <div class="container">
                <h4 class="title text-danger">Welcome, <?php echo htmlentities($user['prename']); ?>!</h4>
                ...
                <span class="input-group-text">
                  <i class="now-ui-icons ui-1_email-85"></i>
                    ...
                    <div class="send-button">
                        <a href="#" class="btn btn-dark btn-round btn-block btn-lg">Send Message</a>
                    </div>
                    ...
                    <p style="margin: 0px">E-Mail: fickie@av.com</p>
                </div>
            </div>
        </div>
    </div>
